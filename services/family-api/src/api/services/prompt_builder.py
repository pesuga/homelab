...
"""
    ...
    def update_file(self, filepath: Path, content: str) -> bool:
        """Update file content and cache"""
        try:
    ...
    def update_core_prompt(self, content: str) -> bool:
        """Update FAMILY_ASSISTANT.md base prompt"""
        return self.update_file(self.prompts_dir / "core" / "FAMILY_ASSISTANT.md", content)

    def update_role_prompt(self, role: str, content: str) -> bool:
        """Update role-specific prompt"""
        return self.update_file(self.prompts_dir / "roles" / f"{role}.md", content)

    def update_skill_prompt(self, skill: str, content: str) -> bool:
        """Update skill prompt"""
