/**
 * Server-side proxy for Phase 2 prompts/skills endpoint
...
export async function GET() {
  try {
    const response = await fetch(`${FAMILY_API_URL}/api/phase2/prompts/skills`, {
      method: 'GET',
      headers: {
    ...
    console.error('Error proxying to Phase 2 prompts/skills endpoint:', error);
    return NextResponse.json(
